...
function generateHTML(storeToArray) {
...
function managerDiv(storeToArray) {
...
function engineerDiv(storeToArray, teamHTML) {


    let createEngineer =
        `<div class="col-md-4">
            <div class="card" id="middle">
                <img src="../lib/img/engineer.png" class="center" id="photo" alt="Manager">
                <h1>${storeToArray.name}</h1>
                <p>ID: ${storeToArray.id}</p>
                <p class="title">${storeToArray.email}</p>
                <p>Github <i class="fa fa-github"></i> : ${storeToArray.github}</p>
                <div style="margin: 24px 0;">
                    <a href="#"><i class="fa fa-dribbble"></i></a>
                    <a href="#"><i class="fa fa-twitter"></i></a>
                    <a href="#"><i class="fa fa-linkedin"></i></a>
...
function internDiv(storeToArray, teamHTML) {


    const createIntern =
        `<div class="col-md-4">
            <div class="card" id="middle">
                <img src="../lib/img/intern.png" class="center" id="photo" alt="Manager">
                <h1>${storeToArray.name}</h1>
                <p>ID: ${storeToArray.id}</p>
                <p class="title">${storeToArray.email}</p>
